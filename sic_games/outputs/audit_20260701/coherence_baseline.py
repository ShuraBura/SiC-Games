"""Deep-audit coherence pass: full social stack (NEW flags OFF (R-26 baseline)), flat climate, multi-seed. Confirms the model
...
def run(seed, steps=900):
    demog = realistic_forager_demog().model_copy(update=dict(
        enable_leader_coherence=False,
        enable_size_repulsion=False,
        enable_malnutrition_fission=False,
        enable_resource_directed_fusion=False))
...
print("Full-stack coherence (NEW flags OFF (R-26 baseline), flat climate, 900 steps):")
