...
2. **Proto-agriculture unlock + soil depletion** (`soil_deplete_frac`, `soil_regrow_per_yr`, `settle_tier2_yield`) — the R-61 A3 "packing de-packs" hypothesis (deplete→move→shrink→re-unlock). *(investigated 2026-07-09, see §C below / RESULTS.)*
