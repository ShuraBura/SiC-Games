...
### Colson, E. (1979). "In Good Years and in Bad: Food Strategies of Self-Reliant Societies." *Journal of Anthropological Research* 35(1):18–29. — **PENDING (JSTOR-gated, not yet filed).**
**Relevance (deferred food-scarcity fission stage 1c, NOT this stage):** famine-coping / aggregation-dispersal as a stress response in small-scale societies. To be obtained for the acute-scarcity-dispersion mechanism.
**Citation tag:** [PENDING — food-scarcity dispersion (Stage 1c, not yet built)]
