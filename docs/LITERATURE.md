...
## Village fission/budding anchors (recovery + settlement-spread mechanism — SCOPING 2026-07-14; PDFs PENDING user fetch)
...
**What is being lifted (SCOPING):** the classic face-to-face village size ceiling (~150–400 before segmentation is forced), a companion anchor to Alberti's logistic (P=0.5 at N≈127, 0.99 at N≈158, already FILED) and Yanomamö ~200 for the fission threshold. **Status: PDF PENDING (old edited-volume chapter — user to fetch).**
**Citation tag:** [SCOPING — village-size fission ceiling ~150–400; PDF pending]

### [supporting] Ancestral Pueblo aggregation & abandonment — *Journal of World Prehistory*, DOI 10.1007/BF02286420 (author/year to confirm on fetch).
**What is being lifted (SCOPING, question-1 support):** collapse does NOT uniformly shrink villages — the settlement system CONTRACTS via COALESCENCE (survivors aggregate up into fewer, larger towns) OR regional ABANDONMENT; the Southwest cycled aggregation↔abandonment for centuries. So "% villages wiped in a crash" has no clean value — count drops, survivors concentrate. **Status: PDF PENDING (Springer paywalled — user to fetch; confirm author).**
**Citation tag:** [SCOPING — crash = coalescence/contraction, not uniform wipeout; PDF pending]
