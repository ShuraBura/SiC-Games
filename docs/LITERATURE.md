...
### Guyon, L. et al. (2024). "Patrilineal segmentary systems provide a peaceful explanation for the post-Neolithic Y-chromosome bottleneck." *Nature Communications* 15. (PMC11043392.) `[FILED literature/PMC11043392.pdf + VERIFIED via verify_anchor.py 2026-09-18]`
...
### Page, A.E. et al. Agta forager wealth/health inequality. (PMC10237286.) `[FILED literature/PMC10237286.pdf + VERIFIED via verify_anchor.py 2026-09-18]`
