...
| Desert game target | GAME_KCAL_TARGETS[DESERT] | **1,201** | kcal/forager-hr | PROVISIONAL — **desert method pending supervisor + Bird 2009 Fig 4 (PDF absent from repo)** | Bare midpoint of 641–1,761; **NOT a defensible median** — Bird 2009 source now in literature/ but its per-species rates are box-plot figures (image read needed; spread ≈641 sand monitor → 100,000+ bustard confirms midpoint overstates). Unchanged pending supervisor read of Fig 4. Derivation: §F.2.1 |
