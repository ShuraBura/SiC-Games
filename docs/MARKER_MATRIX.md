...
| 17 | **fission ceiling** | `settle_community_max` (was `settle_max`) | communities should not persist far past **158 [147–170]** (max scalar stress) and effectively never past **250** (ethnographic maximum) | Alberti 2014 `[VERIFIED VERBATIM]` + Alvard 2009 `[VERIFIED VERBATIM]`; Hamilton 2007 periodic aggregation **165.32 [152.25–181.00]** `[VERIFIED VERBATIM]` | **NOT A MISS — RE-AUDITED (R-106 Add.93, 2026-09-17).** The recorded "220, 39/52 exceed 158" was STALE (52 pre-R105/R106 trajectories) and used the exact-cell `settle_max` (under-counts a multi-cell village). On current canon the FACE-TO-FACE community (3×3 window, `settle_community_max`) is **155 temp / 200 sav** — AT Alberti 158 / Yanomamö ~200, below 250. The cluster-scale over-run (700–880) is the packing-paradox blob (Add.77–79), not distinct communities failing to fission |
