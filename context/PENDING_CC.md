...
- [PENDING] 2026-06-15 | flag | DESERT game value (GAME_KCAL_TARGETS[DESERT]=1,201) unresolved. Bird et al. 2009 (Am. Antiquity 74(1):3–29) is now in literature/ but its per-species post-encounter rates are box-plot Figures, not a table; image rendering unavailable here (no pdftoppm/poppler). Text anchors: sand monitor all-seasons ≈641; bustard >100,000 kcal/hr tail → 1,201 midpoint indefensible. Needs supervisor read of Fig 4 (or poppler install) → encounter-weighted mean/median like forest. Constant left unchanged at 1,201 PROVISIONAL. | home-target: game table §F.2.1 / PARAMETERS §13.3 (desert value, supervisor-gated)
