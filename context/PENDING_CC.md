...
- [PENDING] 2026-06-15 | flag | PER-BIOME STDs not yet literature-sourced (lognormal-draw mechanic, MECHANISMS §9a.6). Anchored: game forest 4,043, game desert 210, forage desert 368. PENDING (terrain-spread fallback until each source's spread is mined): game savanna, game grass; forage wetland, forest, savanna, grass, mountain. Sources are in literature/. CC can mine these on request. | home-target: PARAMETERS §12.4 / §13.3 + game table §F.2.1
